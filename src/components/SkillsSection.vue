    ...
    <div class="max-w-6xl mx-auto">
      ...
      <div class="mt-8 p-7 rounded-2xl border border-gold/20 bg-gradient-to-br from-gold/6 to-ink/90 hidden-init"
        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <a href="https://drive.google.com/file/d/14-ZQYaxuJkVujnA7yIgTq6_G1GsFNyBl/view?usp=drivesdk" class="flex items-center gap-2 px-5 py-2.5 font-mono text-xs tracking-widest uppercase rounded-full border border-gold/30 text-gold hover:bg-gold/10 transition-all duration-300" target="_blank" rel="noopener noreferrer">
            View Certificate ↗
          </a>
        </div>
      </div>
